...
Protected Module DataManager
	...
	#tag Method, Flags = &h0
		Function GeneratePDFPicture() As Picture
		    ...
		    // Colors
		    Var blueBorder As New Color(&h3366BF)
		    Var greenTitle As New Color(&h008033)
		    Var greenDark As New Color(&h007326)
		    Var darkBlue As New Color(&h264080)
		    Var lightBlue As New Color(&hD9E6FF)
		    Var lightGreen As New Color(&hD9FFD9)
